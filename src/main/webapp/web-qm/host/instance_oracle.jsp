...
<div class="col-xs-10 container-main_content">
    ...
    <input type="hidden" id="ID-sid" value="287" />
    <input type="hidden" id="ID-dbname" value="woqu-centos" />
    ...
    <div class="row tabs-wrap">
        ...
        <div class="col-xs-10">
            <ul class="nav nav-tabs">
                <li  class="active" >
                    <a href="<%=request.getContextPath() %>/web-qm/host/instance.htm?sid=287">主机信息</a>
                </li>
            </ul>
        </div>
            ...
            <div class="panel-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td colspan="4">3.12 / 4 / QEMU Virtual CPU version (cpu64-rhel6)</td>
                    </tr>
                    <tr>
                        <td class="text-right">物理内存(GB)</td>
                        <td>3</td>
                        <td class="text-right">系统 / 内核 / 版本</td>
                        <td colspan="4">Linux / 2.6.32-431.5.1.el6.x86_64 / </td>
                    </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <li>
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td><a href="<%=request.getContextPath() %>/web-qm/database/instance_oracle.jsp">JES : jes</a></td>
                            </tr>
                            <tr>
